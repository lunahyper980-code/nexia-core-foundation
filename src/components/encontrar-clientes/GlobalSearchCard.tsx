...
import { Search, Globe, Sparkles, Building2, MapPin, Instagram, Zap, ChevronDown } from 'lucide-react';
          ...
          <div className="w-full max-w-5xl mx-auto">
            ...
            >
              <div className="grid gap-4 md:gap-5 lg:gap-6 lg:grid-cols-[1fr_1fr_auto] items-end">
                {/* Input: Nicho with quick select button */}
                <div className="space-y-1.5">
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      className="bg-background/40 h-10 md:h-11 text-sm border-border/30 focus:border-primary/40 placeholder:text-muted-foreground/50 flex-1"
                    />
                    <Button
                      type="button"
                      variant="outline"
                      ...
                      className="h-10 md:h-11 w-10 md:w-11 flex-shrink-0 bg-background/40 border-border/30 hover:bg-primary/10 hover:border-primary/40 hover:text-primary transition-colors"
                      title="Ver sugestões de nichos"
                    >
