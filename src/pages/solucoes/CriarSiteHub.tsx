  ...
  const options = [
    {
      id: 'template',
      title: 'Modelo Pronto',
      desc: 'Templates profissionais de sites e landing pages prontos para personalizar',
    ...
    },
    {
      id: 'scratch',
      title: 'Criar do Zero',
      desc: 'Total liberdade para criar um site totalmente personalizado',
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-3">
          <h1 className="text-3xl md:text-4xl font-bold text-foreground">
            Como deseja começar seu site?
          </h1>
          <p className="text-base text-muted-foreground max-w-2xl mx-auto">
            Escolha a melhor forma de iniciar seu site ou landing page com rapidez e liberdade.
          </p>
        </div>
