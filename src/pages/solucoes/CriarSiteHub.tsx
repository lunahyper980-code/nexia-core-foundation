...
export default function CriarSiteHub() {
  ...
  const options = [
    {
      id: 'template',
      title: 'Modelo Pronto',
      desc: 'Comece com templates profissionais de sites e landing pages',
      image: solutionTemplate,
      icon: Palette,
      path: '/solucoes/templates?type=site',
      features: ['+15 templates', 'SEO otimizado', 'Responsivo'],
    },
    {
      id: 'scratch',
      title: 'Criar do Zero',
      desc: 'Máxima liberdade para criar um site totalmente personalizado',
      image: solutionScratch,
      icon: Wand2,
      path: '/solucoes/criar/site/novo',
      features: ['100% customizável', 'IA assistida', 'Sem limites'],
    },
  ];

  return (
    <AppLayout title="Criar Site / Página">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-3">
              <h1 className="text-2xl md:text-3xl font-bold text-foreground">Criar Site / Landing Page</h1>
              <Badge variant="secondary" className="bg-primary/10 text-primary border-0">
                Solução Digital
              </Badge>
            </div>
            <p className="text-muted-foreground mt-1">
              Escolha como deseja começar seu site ou página
            </p>
          </div>
        </div>
