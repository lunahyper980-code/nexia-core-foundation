...
export default function Dashboard() {
  ...
  const stats = [
    {
      title: 'Soluções Criadas',
      value: (isOwner ? ownerMetrics.projects : realMetrics.projects).toString(),
      description: 'Projetos digitais',
      icon: Layers,
      color: 'text-primary',
    ...
    {
      title: 'Clientes',
      value: (isOwner ? ownerMetrics.clients : realMetrics.clients || clients.length).toString(),
    ...
    {
      title: 'Entregas',
      value: (isOwner ? ownerMetrics.deliveries : realMetrics.deliveries).toString(),
